<template>
  <div class="animation-wrap">
    <img class="profile-back" :src="this.$settings.cos_url+'static/profile-back.png'"/>
    <div class="user-info">
      <img class="avatar var-elevation--1" :src="icon">
      <div class="ribbon var-elevation--1">个人主页
        <var-icon name="menu-right"/>
      </div>
      <div class="info-wrap">
        <div v-if="this.$store.state.is_login">
          <div class="name">{{this.$store.state.user.username}}
            <var-chip size="tiny" class="id">UID:{{this.$store.state.user.id}}</var-chip>
          </div>
        </div>
        <div v-else>
      ...
      <var-row>
        <var-col span="11">
          <div class="token-item clear-fix">
            <img class="token-img" src="~assets/img/get_token.png" alt="">
            <div class="token-text">获取PMB</div>
          </div>
        </var-col>
        <var-col span="11" offset="2">
          <div class="token-item clear-fix">
            <img class="token-img" src="~assets/img/my_account.png" alt="">
